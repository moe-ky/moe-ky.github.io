...
projectMapping = {
    tld: `
    <p>
        <a href="/"><i class="fa fa-home" style="font-size:24px"></a></i> <header> <h1> The Letter Digest </h1> </header>
        <br>provides you with Insights & Digests on your favorite newsletters.
    ...
    ltc: `
    <p>
        <a href="/"><i class="fa fa-home" style="font-size:24px"></a></i> <header> <h1> Learn To Code </h1> </header>
        <br> I created this small digital e-book for beginners looking to take their coding journey to the next level.
